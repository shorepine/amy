...
class TestPcmLoop(AmyTest):
  """I think these don't work at the moment because under Gamma9001 there are no loop points."""

  def run(self):
    amy.send(time=0, osc=0, wave=amy.PCM, preset=10, wave_submode=amy.PCM_LOOP)
