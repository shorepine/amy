...
sources = ['algorithms.c', 'amy.c', 'delay.c', 'envelope.c', 'filters.c', 'midi.c', 'sequencer.c', 'transfer.c', 'custom.c', 'patches.c', 'libminiaudio-audio.c', 'oscillators.c', 'partials.c', 'interp_partials.c', 'pcm.c', 'pyamy.c', 'log2_exp2.c']
os.environ["CC"] = "gcc"
os.environ["CXX"] = "g++"
