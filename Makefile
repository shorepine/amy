...
-s EXPORTED_FUNCTIONS="['_amy_play_message', '_amy_reset_sysclock', '_amy_sysclock', '_amy_live_stop', '_amy_get_input_buffer', '_amy_set_input_buffer', '_amy_live_start', '_amy_start', '_sequencer_ticks', '_malloc', '_free']"
